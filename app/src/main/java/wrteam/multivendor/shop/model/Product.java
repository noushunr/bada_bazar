...
public class Product implements Serializable {
    ...
    String seller_name, return_days, is_approved, seller_id, tax_id, tax_percentage, id, name, slug, subcategory_id, row_order, image, description, status, date_added, category_id, indicator, manufacturer, made_in, return_status, cancelable_status, till_status;
